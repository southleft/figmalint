...
const analyzeButton = document.getElementById('analyze-component') as HTMLButtonElement;
...
function handleApiKeySaved(success: boolean) {
...
function handleApiKeyStatus(hasKey: boolean) {
  apiKeySaved = hasKey;
...
function handleAnalysisComplete(success: boolean, message: string) {
...
function updateAnalyzeButtonState(enabled: boolean) {
