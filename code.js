...
exports.handleUIMessage = handleUIMessage;
exports.extractComponentInfo = extractComponentInfo;
exports.fetchClaudeAnalysis = fetchClaudeAnalysis;
...
async function handleSaveApiKey(apiKey) {
    try {
        ...
        if (!(0, claude_1.isValidApiKeyFormat)(apiKey)) {
...
async function handleAnalyzeComponent() {
    try {
        ...
        const prompt = (0, claude_1.createDesignAnalysisPrompt)(componentInfo.name, componentInfo.structure);
...
async function fetchClaudeAnalysis(prompt, apiKey) {
    try {
        ...
        const analysis = await (0, claude_1.fetchClaude)(prompt, apiKey);
        return analysis;
    }
    catch (error) {
